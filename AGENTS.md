...
- Workspace ID: `a2d51d97-d9fb-4382-87ae-2f6207df67bb`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/a2d51d97-d9fb-4382-87ae-2f6207df67bb.
...
2. `npx ngodingpakeai connect --workspace a2d51d97-d9fb-4382-87ae-2f6207df67bb --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/a2d51d97-d9fb-4382-87ae-2f6207df67bb. Only pass on links the CLI actually printed — never assemble one from an id yourself.
